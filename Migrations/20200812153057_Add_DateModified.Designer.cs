...
namespace APIHomeWork.Migrations
{
    ...
    [Migration("20200812153057_Add_DateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APIHomeWork.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("APIHomeWork.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APIHomeWork.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("APIHomeWork.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("APIHomeWork.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APIHomeWork.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("APIHomeWork.Models.Course", b =>
                {
                    b.HasOne("APIHomeWork.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("APIHomeWork.Models.CourseInstructor", b =>
                {
                    b.HasOne("APIHomeWork.Models.Course", "Course")
                    ...
                    b.HasOne("APIHomeWork.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("APIHomeWork.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("APIHomeWork.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("APIHomeWork.Models.OfficeAssignment", b =>
                {
                    b.HasOne("APIHomeWork.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("APIHomeWork.Models.OfficeAssignment", "InstructorId")
